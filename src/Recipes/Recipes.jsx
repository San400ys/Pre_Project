export const Recipes = [
    {
        ...
        "cooking_method": "Вскипятить воду в кастрюле и добавить соль.\nДобавить пасту и варить в соответствии с инструкцией на упаковке до готовности.\nВ то время как паста варится, разогреть сковороду на среднем огне.\nДобавить оливковое масло и обжарить креветки до золотистой корочки, приправить солью и перцем по вкусу.\nДобавить измельченный чеснок и обжарить до аромата, затем добавить мелко нарезанный петрушку.\nОткинуть воду с отварной пасты и добавить ее в сковороду с креветками. Тщательно перемешать, чтобы паста покрылась соусом.\nПодавать горячим, посыпав пармезаном и украсив ломтиками лимона.",
        "prep_time": "25 минут",
